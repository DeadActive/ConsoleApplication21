...
void Human::edit_name()
{
	std::string tmp;
	std::cout << "Name: "; std::getline(std::cin, tmp);
	this->set_name(tmp.c_str());
}

void Human::edit_surname()
{
	std::string tmp;
	std::cout << "Surname: "; std::getline(std::cin, tmp);
	this->set_surname(tmp.c_str());
}
...
void Human::edit_sex()
{
	...
	this->set_sex(tmp.c_str());
}

void Human::edit_height()
{
	std::string tmp;
	std::cout << "Height: "; std::getline(std::cin, tmp);
	this->set_height(tmp.c_str());
}

void Human::edit_weight()
{
	std::string tmp;
	std::cout << "Weight: "; std::getline(std::cin, tmp);
	this->set_weight(tmp.c_str());
}

void Human::edit_phone()
{
	std::string tmp;
	std::cout << "Phone: "; std::getline(std::cin, tmp);
	this->set_phone(tmp.c_str());
}

void Human::edit_adress()
{
	std::string tmp;
	std::cout << "Adress: "; std::getline(std::cin, tmp);
	this->set_adress(tmp.c_str());
}
